...
public class Robot extends TimedRobot {
  ...
  Victor LF = new Victor(2);
  Victor LB = new Victor(4);
  Victor RF = new Victor(3);
  Victor RB = new Victor(5);
  ...
  Solenoid rockettwo = new Solenoid(2);
  Solenoid spider = new Solenoid(5);
